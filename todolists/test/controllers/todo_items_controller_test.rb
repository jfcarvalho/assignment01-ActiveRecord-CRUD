...
class TodoItemsControllerTest < ActionController::TestCase
  ...
  test "should create todo_item" do
    assert_difference('TodoItem.count') do
      post :create, todo_item: { completed: @todo_item.completed, description: @todo_item.description, due_date: @todo_item.due_date, false}: @todo_item.false}, title: @todo_item.title, {default: @todo_item.{default }
    end
  ...
  test "should update todo_item" do
    patch :update, id: @todo_item, todo_item: { completed: @todo_item.completed, description: @todo_item.description, due_date: @todo_item.due_date, false}: @todo_item.false}, title: @todo_item.title, {default: @todo_item.{default }
    assert_redirected_to todo_item_path(assigns(:todo_item))
  end
